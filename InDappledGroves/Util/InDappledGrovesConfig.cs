...
namespace InDappledGroves.Util
{
    class InDappledGrovesConfig
    {
        ...
        public float baseWorkstationMiningSpdMult { get; set; } = 1.25f;
        ...
        public float baseWorkstationResistanceMult { get; set; } = 1f;
        ...
        public float baseGroundRecipeMiningSpdMult { get; set; } = 1f;
        ...
        public float baseGroundRecipeResistaceMult { get; set; } = 1f;
