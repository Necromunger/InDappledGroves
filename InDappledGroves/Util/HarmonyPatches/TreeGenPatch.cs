    ...
    public static class TreeGenPatch
    {
        ...
        public static void Execute(Harmony harmony)
        {
            ...
            harmony.Patch(typeof(TreeGen).GetMethod("growTree", BindingFlags.Instance | BindingFlags.Public),
                transpiler: new HarmonyMethod(typeof(TreeGenPatch).GetMethod("growTreeTranspiler", BindingFlags.Static | BindingFlags.Public))
            );
            //harmony.Patch(typeof(TreeGen).GetMethod("growTree", BindingFlags.Instance), 
            //postfix: new HarmonyMethod(typeof(TreeGenPatch).GetMethod("growTree", BindingFlags.Public))
            //);
        }
